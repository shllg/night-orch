...
describe('buildActionHints', () => {
  ...
  it('shows focused run controls when detail view is open', () => {
    ...
    expect(sections.navigation).toContain('[1-7]tabs [h/l]tabs [j/k]scroll run')
  ...
  it('shows stats polling controls on stats tab without retry/rebase', () => {
    ...
    expect(sections.navigation).toBe('[1-7]tabs [h/l]tabs')
  ...
  it('shows settings controls on settings tab', () => {
    ...
    expect(sections.navigation).toContain('[1-7]tabs [h/l]tabs [j/k]select setting')
  ...
  it('shows file-loop controls on file-loop tab', () => {
    ...
    expect(sections.navigation).toContain('[1-7]tabs [h/l]tabs [j/k]select repo')
